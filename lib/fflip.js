...
var self = module.exports = {
    ...
    _express_middleware: function(req, res, next) {
        ...
        req.fflip.hasFeature = function(fName) {
            if(req.fflip.features === undefined) {
                console.error('FFlip Features undefined: Call setFeatures() before using hasFeature() & consider adding middleware to always set features');
                return null;
            }
